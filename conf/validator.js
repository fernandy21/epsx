...
function validasifile() {
	$ukuran_dktp           = $_FILES['dktp']['size'];
	$ukuran_dkj            = $_FILES['dkj']['size'];
	// $ukuran_kartu_berobat  = $_FILES['kartu_berobat']['size'];
	$ukuran_dgl            = $_FILES['dgl']['size'];
	$ukuran_dsrujuk        = $_FILES['dsrujuk']['size'];
	$ukuran_dskontrol      = $_FILES['dskontrol']['size'];
	

	if ($ukuran_dktp > 250000) {
		<div class="alert alert-danger" role="alert">This is a danger alert—check it out!</div>
	}
	if ($ukuran_djk > 250000) {
		<div class="alert alert-danger" role="alert">This is a danger alert—check it out!</div>
	}
	if ($ukuran_kartu_berobat > 250000) {
		<div class="alert alert-danger" role="alert">This is a danger alert—check it out!</div>
	}
	if ($ukuran_dgl > 250000) {
		<div class="alert alert-danger" role="alert">This is a danger alert—check it out!</div>
	}
	if ($ukuran_dsrujuk > 250000) {
		<div class="alert alert-danger" role="alert">This is a danger alert—check it out!</div>
	}
	if ($ukuran_dskontrol > 250000) {
		<div class="alert alert-danger" role="alert">This is a danger alert—check it out!</div>
	}
