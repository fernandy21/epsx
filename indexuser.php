...
<body class="theme-pink">
    ...
    <section>
        ...
        <aside id="leftsidebar" class="sidebar">
            <div class="user-info">
                <div class="image">
                    <img src="<?=$_SESSION["photo"];?>" width="55" height="48" alt="Photo" />&nbsp;&nbsp;&nbsp;&nbsp;<b><font color="#000000">No.RM : <?=encrypt_decrypt($_SESSION["ses_pasien"],"d");?></font></b>
                </div>
                <div class="info-container">
                    <div class="name" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><b><font color="#000000"><?=$_SESSION["nm_pasien"];?></font></b></div>
                    <div class="email"><?=$_SESSION["email"];?></div>
                    <div class="btn-group user-helper-dropdown" style="color:black;">
                        <i class="material-icons" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">keyboard_arrow_down</i>
                        <ul class="dropdown-menu pull-right">
                            <li><a href="index.php?act=KartuPasien&hal=KartuPasien"><i class="material-icons">person</i>Profile</a></li>
